    ...
    var a={autostart:!0,
        ...
        showPhoto:function(){}},
            ...
            e={autostart:!0,
                ...
                zoomSize:"fill",
                canChangeMode:!1},
            f={moveToLeft_moveFromRight:["pt-page-moveToLeft","pt-page-moveFromRight"],
                ...
                rotateSlideOut_rotateSlideIn:["pt-page-rotateSlideOut","pt-page-rotateSlideIn"]},
                    g=function(a){
                        var b=jQuery,
                            c=[];
                        return b.each(a,function(a,b){c.push(b)}),c}(f),
                            h={moveToLeft_moveFromRight:"moveToRight_moveFromLeft",
                        ...
                        rotateSlideOut_rotateSlideIn:"rotateSlideOut_rotateSlideIn"},
                            i=function(){return this.length?this[0].outerHTML||function(a)
                                    ...
                                    {var c={show:!1,
                                        ...
                                        b=a.extend({},c,b),
                                                this.each(function(){
                                                    ...
                                                    i=function(){b.fadeIn?c.fadeIn(500):c.show()},
                                                    j=function(){b.fadeOut?c.fadeOut(500):c.hide()},
                                                    k=function(){b.fadeInLoader?d.not(":visible").fadeIn(500):d.not(":visible").show()},
                                                    l=function(){b.fadeOutLoader?d.filter(":visible").fadeOut(500):d.filter(":visible").hide()};
                                                    h||(g.addClass("overlayContainer"),
                                                    g.append('<span class="overlay" style="display: none;"><span class="imageLoaderPositionAbsolute" style="display: none;">\n\
                                                              <span class="fa fa-spin fa-spinner"></span><span class="progress-value" style="display: none;">0</span></span></span>'),
                                                    b.afterInit()),
                                                    c=g.children(".overlay"),
                                                    d=g.find(".imageLoaderPositionAbsolute"),
                                                    e=d.find(".progress-value"),
                                                    f=d.find(".fa-spinner"),
                                                    b.resetProgress&&e.html("0"),
                                                    b.showProgress?(d.addClass("preloadAll"),
                                                    e.show(),
                                                    f.hide()):b.hideProgress&&(d.removeClass("preloadAll"),
                                                    e.hide(),
                                                    f.show()),
                                                    c.stop(!1,!0),
                                                    d.stop(!1,!0),
                                                    b.show?i():b.hide&&j(),
                                                    b.showLoader?k():b.hideLoader&&l()})}}(),
                                                k=function(a)
                                                    {var b=jQuery;
                                                        return b.fn.overlay=a,
                                                                function(a){a=b.extend({interval:1e3,
                                                                            skip:":not(*)",
                                                                            start:function(){b("body").overlay({fadeIn:!1,fadeOut:!1,show:!0,showLoader:!0}),
                                                                            b("body").show()},success:function(){b("body").overlay({hide:!0})},
                                                                            progress:function(){}},a),
                                                                                this.each(function(){function c(){
                                                                                        var e,
                                                                                        i=!0,
                                                                                        j=0;
                                                                                        g.each(function(){b(this)[0].complete&&b(this)[0].naturalWidth>0?j++:i=!1}),
                                                                                        e=parseInt(100*j/h),
                                                                                        a.progress({percent:e}),
                                                                                        i?(clearTimeout(d),
                                                                                        f.remove(),
                                                                                        a.success()):d=setTimeout(c,a.interval)}var d,
                                                                                        e=b(this),
                                                                                        f=b(),
                                                                                        g=b(),
                                                                                        h=0;
                                                                                        e.append('<div class="jLoaderTmp" style="position: absolute; width: 0; height: 0; line-height: 0; font-size: 0; visibility: hidden; overflow: hidden; z-index: -1;"></div>'),
                                                                                        f=e.children(".jLoaderTmp:last-child"),
                                                                                        b(e).add(e.find("*")).not(a.skip).each(function(){
                                                                                            var a;
                                                                                            "none"!==b(this).css("background-image")&&(a=b(this).css("background-image"),
                                                                                            /url/.exec(a)&&(a=a.replace('"',"").replace("'","").replace(" ","").replace("url(","").replace(")",""),
                                                                                            f.append('<img src="'+a+'">')))}),
                                                                                        g=e.find("img:not( "+a.skip+")"),
                                                                                        e.is("img")&&(e.is(a.skip)||(g=g.add(e))),
                                                                                        h=parseInt(g.length),
                                                                                        a.start(),c()})}}(j),
                                                                                    l=function(){
                                                                                        var a=jQuery,
                                                                                                b=a("title");
                                                                                        return function(c){c=a.extend({},{stateObj:{},title:b.html(),path:""},c),
                                                                                                    window.history.pushState(c.stateObj,c.title,
                                                                                            document.location.href.split("#")[0]+"#"+c.path)}}(),
                                                                                            m=function(){var a=!1;if("Microsoft Internet Explorer"===navigator.appName){
                                                                                                    var b=navigator.userAgent,
                                                                                                            c=new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})");
                                                                                                    null!==c.exec(b)&&(a=!0)}return a},
                                                                                                    n=function(){
                                                                                                        var a=!1;
                                                                                                        if("Microsoft Internet Explorer"===navigator.appName){
                                                                                                            var b=navigator.userAgent,
                                                                                                                    c=new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})");
                                                                                                            null!==c.exec(b)&&(a=parseFloat(RegExp.$1),a=9>a)}return a},
                                                                                                            o=function(){
                                                                                                                var a=jQuery,
                                                                                                                        b=a("html");
                                                                                                                return function(){
                                                                                                                    0===b.find(".jgallery").length?b.removeClass("has-jgallery"):b.addClass("has-jgallery"),
                                                                                                                    0===b.find(".jgallery.hidden").length?b.removeClass("has-hidden-jgallery"):b.addClass("has-hidden-jgallery"),
                                                                                                                    0===b.find(".jgallery:not(.hidden)").length?b.removeClass("has-visible-jgallery"):b.addClass("has-visible-jgallery")}},
                                                                                                            p=function(a){
                                                                                                                var b=jQuery,
                                                                                                                        c=b("head"),
                                                                                                                        d=0,
                                                                                                                        e=function(a){
                                                                                                                            a.is("[data-advanced-animation-id]")||(this.cols=1,
                                                                                                                                                                   this.rows=1,
                                                                                                                                                                   this.direction="forward",
                                                                                                                                                                   this.animation=!0,
                                                                                                                                                                   this.$element=a,
                                                                                                                                                                   this.$element.filter(":not( [data-advanced-animation-id] )").attr("data-advanced-animation-id",++d),
                                                                                                                                                                   ...
                                                                                                                                                                   return e.prototype={next:function(){var a=this.$element.find(".pt-part").eq("backward"===this.direction?-1:0).find(".pt-page-current:not(.pt-page-prev)").next();
                                                                                                                                                                          a.length?this.show(a):this.show(this.$element.find(".pt-part").eq("backward"===this.direction?-1:0).find(".pt-page").eq(0))},
                                                                                                                                                                          show:function(a,c){
                                                                                                                                                                              var d=a.prevAll().length+1;a.is(".pt-page-current:not(.pt-page-prev)")||(c=b.extend({},{animation:!0},c),
                                                                                                                                                                              this.animation=c.animation,
                                                                                                                                                                              this._waveJumpToEnd(),
                                                                                                                                                                              this.animation?this._runWave(d):this._showParts(this.$element.find(".pt-part"),d),
